...
export default function Profile() {
  ...
  const handleUpdate = async ({ username, email, bio, avatarFile, removeAvatar }) => {
    console.log("Profile handleUpdate:", { avatarFile: !!avatarFile, removeAvatar });
    setUpdating(true);
    try {
      const res = await api.updateProfile({ username, email, bio, avatarFile, removeAvatar });
      setProfile(res.user);
      setEditing(false);
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-20 pb-24">
                ...
                <div className="mt-6">
                  {isOwnProfile ? (
                    ...
                    <button
                      ...
                      disabled={updating}
                      className={`px-6 py-2.5 rounded-xl font-medium transition-all ${following
                        ? "bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray,600"
                        : "bg-blue-600 text-white hover:bg-blue-700"
                        } focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900 ${following ? "focus:ring-gray-500" : "focus:ring-blue-500"
                        }`}
                    >
          ...
          <div className="mt-8 -mb-px flex border-b border-gray-200 dark:border-gray-800">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-1 py-3 text-center font-medium text-sm transition-colors ${activeTab === tab
        ...
        <AnimatePresence>
          {toast.message && (
            ...
            >
              <div
                className={`flex items-center gap-2 px-4 py-3 rounded-full shadow-lg text-white font-medium ${toast.type === "success" ? "bg-green-600" : "bg-red-600"
                  }`}
              >
